...
ifneq ($(ATHENZ_SIA_DEFAULT_ROLE_CERT_DIR),)
LDFLAGS_ARGS += -X 'github.com/AthenZ/k8s-athenz-sia/v3/pkg/config.DEFAULT_ROLE_CERT_DIR=$(ATHENZ_SIA_DEFAULT_ROLE_CERT_DIR)'
endif
