...
func (idCfg *IdentityConfig) loadFromENV() error {
	...
	loadEnv("ROLE_CERT_COUNTRY", &idCfg.roleCertCountry)
	loadEnv("ROLE_CERT_PROVINCE", &idCfg.roleCertProvince)
	loadEnv("ROLE_CERT_ORGANIZATION", &idCfg.roleCertOrganization)
...
func (idCfg *IdentityConfig) loadFromFlag(program string, args []string) error {
	...
	f.StringVar(&idCfg.roleCertCountry, "role-cert-country", idCfg.roleCertCountry, "Country Name value of the generated CSR which is used for issuing role certificates")
	f.StringVar(&idCfg.roleCertProvince, "role-cert-province", idCfg.roleCertProvince, "State or Province Name value of the generated CSR which is used for issuing role certificates")
	f.StringVar(&idCfg.roleCertOrganization, "role-cert-organization", idCfg.roleCertOrganization, "Organization Name value of the generated CSR which is used for issuing role certificates")
	// RoleAuthHeader
